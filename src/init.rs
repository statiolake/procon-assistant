...
fn generate_vscode_tasks_json(p: &Path) -> io::Result<()> {
    ...
    writeln!(f, r#"        }},"#)?;
    writeln!(f, r#"        {{"#)?;
    writeln!(f, r#"            "label": "procon-assistant run","#)?;
    writeln!(f, r#"            "type": "shell","#)?;
    writeln!(f, r#"            "command": "procon-assistant","#)?;
    writeln!(f, r#"            "args": ["#)?;
    writeln!(f, r#"                "run""#)?;
    ...
    writeln!(f, r#"        }},"#)?;
    writeln!(f, r#"        {{"#)?;
    writeln!(f, r#"            "label": "procon-assistant init","#)?;
    writeln!(f, r#"            "type": "shell","#)?;
    writeln!(f, r#"            "command": "procon-assistant","#)?;
    writeln!(f, r#"            "args": ["#)?;
    writeln!(f, r#"                "init""#)?;
    ...
    writeln!(f, r#"        }},"#)?;
    writeln!(f, r#"        {{"#)?;
    writeln!(f, r#"            "label": "procon-assistant fetch","#)?;
    writeln!(f, r#"            "type": "shell","#)?;
    writeln!(f, r#"            "command": "procon-assistant","#)?;
    writeln!(f, r#"            "args": ["#)?;
    writeln!(f, r#"                "fetch""#)?;
    ...
    writeln!(f, r#"        }},"#)?;
    writeln!(f, r#"        {{"#)?;
    writeln!(f, r#"            "label": "procon-assistant download","#)?;
    writeln!(f, r#"            "type": "shell","#)?;
    writeln!(f, r#"            "command": "procon-assistant","#)?;
    writeln!(f, r#"            "args": ["#)?;
    writeln!(f, r#"                "download""#)?;
    writeln!(f, r#"            ]"#)?;
    writeln!(f, r#"        }}"#)?;
    writeln!(f, r#"    ]"#)?;
    writeln!(f, r#"}}"#)?;
